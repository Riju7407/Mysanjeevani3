...
export default function EditBankDetailsDoctorPage() {
  ...
  const fetchBankDetails = async () => {
    try {
      const res = await fetch(`/api/bank-details?doctorId=${doctorId}`);
    ...
    return (
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <Link href="/doctor/wallet/add-bank-details" className="text-indigo-600 hover:text-indigo-800 font-semibold">
              Add Bank Details
            </Link>
          </div>
        </div>
